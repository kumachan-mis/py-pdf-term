...
class FLRRankingDataCollector(BaseRankingDataCollector[FLRRakingData]):
    # public
    ...
    def collect(self, domain_candidates: DomainCandidateTermList) -> FLRRakingData:
